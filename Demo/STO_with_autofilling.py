...
def check_db(name):                                                                                                     #Функция для создания базы данных
    ...
    if flag_debug==True or 1==1:
        try:
            cursor.execute(
                "INSERT INTO employees (login,email, password, access_rights) VALUES ('Viktor','Viktor@12345', '12345', 'Механик')")
            cursor.execute(
                "INSERT INTO employees (login,email, password, access_rights) VALUES ('Viktor-Vektor','Viktor-Vektor@Q12345Q','Q12345Q', 'Старший механик')")
            cursor.execute(
                "INSERT INTO employees (login,email, password, access_rights) VALUES ('321','321@Q123','321', 'Механик')")
            cursor.execute(
                "INSERT INTO employees (login,email, password, access_rights) VALUES ('123','123@Q123','123', 'Старший механик')")
            cursor.execute(
                "INSERT INTO employees (login,email, password, access_rights) VALUES ('1234','123@Q123','1234', 'Директор')")
            cursor.execute(
